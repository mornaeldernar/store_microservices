...
public static class BasketApiEndpoints 
{
    public static void RegisterEndpoints( this IEndpointRouteBuilder routeBuilder)
    {
        ...
        routeBuilder.MapPut("/{customerId}", ([FromServices] IBasketStore basketStore, string customerId, AddBasketProductRequest addBasketRequest) => {
            var customerBasket = new CustomerBasket { CustomerId = customerId };
            customerBasket.AddBasketProduct(new BasketProduct(addBasketRequest.ProductId, 
                addBasketRequest.ProductName, 
                addBasketRequest.Quantity));
